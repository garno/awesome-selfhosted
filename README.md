...
- [Accent](https://www.accent.reviews/) - Open-source, self-hosted, developer-oriented translation tool built with Elixir and Ember. ([Source code](https://github.com/mirego/accent)) `BSD-3-Clause` `Elixir`
